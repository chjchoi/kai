...
int fd1,fd3,fd_status;
int fd_status_open=0;
static char ch=0;
static	int rv=0;
int main(void)
{
	...
	if((fd_status =open("/dev/status_gpio",O_RDONLY))<0)
	{
	...
	fd1 =open("/dev/ttyS0",O_WRONLY);
        fd3 =open("/dev/ttyS2",O_WRONLY);
